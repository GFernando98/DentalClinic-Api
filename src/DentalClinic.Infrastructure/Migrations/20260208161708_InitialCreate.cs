        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Treatments_TreatmentCategory_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Odontograms_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ToothRecordId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToothSurfaceRecords", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    SurfacesAffected = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TreatmentRecords_ToothRecords_ToothRecordId",
                        column: x => x.ToothRecordId,
                        principalTable: "ToothRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Odontograms_DoctorId",
                table: "Odontograms",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_Odontograms_ExaminationDate",
                table: "Odontograms",
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[IdentityNumber] IS NOT NULL AND [IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_ToothRecords_OdontogramId_ToothNumber",
                table: "ToothRecords",
                columns: new[] { "OdontogramId", "ToothNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ToothSurfaceRecords_ToothRecordId_Surface",
                table: "ToothSurfaceRecords",
                columns: new[] { "ToothRecordId", "Surface" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentRecords_PerformedDate",
                table: "TreatmentRecords",
                column: "PerformedDate");

            migrationBuilder.CreateIndex(
                name: "IX_TreatmentRecords_ToothRecordId",
                table: "TreatmentRecords",
